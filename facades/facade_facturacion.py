...
from Funciones.zip_manager import Zip_Manager
import zipfile
        ...
        with zipfile.ZipFile(zip_buffer,  "w", zipfile.ZIP_DEFLATED) as zipf:
            while factura < len(datos_factura) and ID != None:
                ...
                if(ID_anterior == None or ID != ID_anterior):
                    ...
                    zipf = zip_writer.zip_write_str(zipf, f"factura_{datos_CAE[0]}{factura}.pdf", pdf_contenido[1])
                    ...
                    row_next_historial = facade_historial.obtener_row_historial(dataframe_historial[1])
                    facade_historial.escribir_historial(datos_historial, dataframe_historial[1], row_next_historial)

                    facade_historial.guardar_historial(dataframe_historial[0], file_name)
