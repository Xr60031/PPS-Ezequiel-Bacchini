...
def verificar_formateo_datos(datos_factura):
    return(
        ...
        isinstance(datos_factura["tipo_factura_nota"],int) and
        ...
        isinstance(datos_factura["items"], (list, type(None))) and
        isinstance(datos_factura["nro_cbte_anular"], (int, type(None))) and
        isinstance(datos_factura["fecha_emision"], datetime.datetime)
    )