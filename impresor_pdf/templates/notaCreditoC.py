...
class Nota_Credito_C(Template):
    ...
    def armar_datos_usuario_opcionales(self, biblioteca_datos_vendedor, datos_CAE, datos_factura):
        return f'Identificador Nota: {self.hacer_identificador_nota(biblioteca_datos_vendedor["Punto_de_venta"], datos_CAE[2])}'

    def unir_datos_usuario(self, datos_comunes, datos_opcionales):
        datos_unidos = []
        datos_unidos.extend(datos_comunes)
        datos_unidos.append(datos_opcionales)
        return datos_unidos
