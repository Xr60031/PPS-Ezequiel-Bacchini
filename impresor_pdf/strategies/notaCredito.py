...
import math
def hacer_identificador_nota(punto_venta, numero_comprobante):
    ...
    def generar_pdf(self,
        ...
        fecha_emision):
            ...
            while iteracion < 3:
                ...
                identificador_nota = hacer_identificador_nota(punto_venta, Identificador_factura)
                pdf.cell(0,identacion, F'Identificador: {identificador_nota}', ln=True, align='L')
                self.hacer_Linea(pdf)
